"""
Django settings for bukcare_backend project.
...
SECRET_KEY = 'django-insecure-oq&kh(1$d269mdl&vut0gy1z(pwperbi60j0@be2#ilj_y$d1w'
...
ROOT_URLCONF = 'bukcare_backend.urls'
...
WSGI_APPLICATION = 'bukcare_backend.wsgi.application'
